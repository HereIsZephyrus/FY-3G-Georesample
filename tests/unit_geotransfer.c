...
void test_geotransfer(void) {
    ...
    for (int i = 0; i < 10; i++) {
        ...
        TEST_ASSERT_DOUBLE_WITHIN_MESSAGE(1e-10, in_height, iter_height, "height calculated by iterative method is equal to the input height");
        ...
        TEST_ASSERT_DOUBLE_WITHIN_MESSAGE(1e-10, in_height, lagrange_height, "height calculated by Lagrange method is equal to the input height");
    }
}
